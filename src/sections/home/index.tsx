...
const Hero = ({ params: { lang } }: HeroProps) => (
  ...
  >
    <div className='flex flex-col gap-y-16 items-start pl-4 text-gray-50'>
      ...
      <p className='text-xl lg:w-[30rem] leading-8 font-italic font-light'>
        &ldquo;Santiago Laight is exactly the kind of person you want working at your company.&rdquo;
        - <span className='font-bold'>Jason Gager (Project Manager at Impexium)</span>
      </p>
      <div>
        <Link
